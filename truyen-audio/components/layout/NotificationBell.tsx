...
export default function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      <button onClick={handleOpen} className="relative rounded-lg p-2 text-gray-400 hover:bg-[#2a2a4a] hover:text-white" aria-label="Thông báo">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 rounded-lg border border-[#2a2a4a] bg-[#1a1a2e] shadow-xl z-50">
